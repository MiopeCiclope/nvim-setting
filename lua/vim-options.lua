...
-- watch on cmd command from vim
function Run_script_and_watch_output(cmd)
	local output = {}
	...
	vim.fn.jobstart(cmd, {
		...
		on_stderr = on_output,
		on_exit = function()
			-- Open a new buffer and display the output
...
vim.api.nvim_set_keymap(
	"n",
	"<leader>rs",
	':lua Run_script_and_watch_output("npm run start")<CR>',
